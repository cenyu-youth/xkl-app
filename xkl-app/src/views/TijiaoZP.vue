<template>
  <div class="ti_jaio_zp">
    <NavBar title="提交追评" :isTrueArrow="true"/>
    ...
    <div class="setp_task">
      ...
      <van-button class="btns" @click="submit" style="margin-top: 20px;" type="primary" size="large">提交任务追加评价</van-button>
  ...
  methods: {
    ...
    async submit(){
      ...
      this.axios({
        ...
        method: 'POST',
        url: 'http://106.12.220.193/Webapp/order/addEvaluateOrderInfo',
        data: qs.stringify({
